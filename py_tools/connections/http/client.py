...
class AsyncHttpClient:
    ...
    Examples:
        ...
        >>> text_data = await AsyncHttpClient().get(url, params={"test": "lc"}).text()
        >>> json_data = await AsyncHttpClient().post(url, data={"test": "lc"}).json()
...
class HttpClient:
    ...
    Examples:
        ...
        >>> HttpClient().get("http://www.google.com", params={"name": "lc"}).bytes
        >>> HttpClient().post("http://www.google.com", data={"name": "lc"}).json
