...
from src.enums import ProjectPriority, ProjectStatusEnum
...
class ProjectTable(BaseTable):
    ...
    project_name: Mapped[str] = mapped_column(String(100), default="", comment="项目名称")
    project_desc: Mapped[str] = mapped_column(String(1024), default="", comment="项目描述")
    project_status: Mapped[str] = mapped_column(String(100), default=ProjectStatusEnum.todo.value, comment="项目状态")
